...
def run_test(money_value, file_name, combination):
    ...
    return [profit, winrate, file_name, combination[0][0], combination[0][1], combination[0][2], combination[0][3], combination[1][0], combination[1][1], combination[1][2], combination[1][3]]