...
#al.run_test(100, 'Answers_2020.csv', generate_all_combinations(Smas, Sma_spans, Emas, Ema_spans, Lines, Lines_spans, Others, Trends))

al.run_test(100, 'Answers_2021.csv', IO.combinations_reader('Results_backup\\Results_2021.csv', 7))
